...
export type WorkflowEvent = ExecutionStartedEvent | ExecutionResumedEvent | ExecutionWaitingEvent | ExecutionCompletedEvent | ExecutionExpiredEvent | ExecutionErrorEvent | NodeExecutedEvent | WhatsappMessageReceivedEvent | WhatsappSessionConnectedEvent | WhatsappSessionDisconnectedEvent | WhatsappQrCodeEvent;
